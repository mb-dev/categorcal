...
/***/ function(module, exports, __webpack_require__) {
	...
	const startQuarter = new Date(2016, 9, 1);
	const store = {};
	function onChange() {
	}
	...
	function listUpcomingEvents() {
	    return __awaiter(this, void 0, void 0, function* () {
	        const resp = yield gapi.client.calendar.events.list({
	            calendarId: "primary",
	        ...
	        if (events.length > 0) {
	            for (let i = 0; i < events.length; i++) {
	                ...
	                if (event.description) {
	                    tags = event.description.match(tagRegex) || [];
	                    people = event.description.match(peopleRegex) || [];
	                }
	                appendPre(event.summary + " (" + when + ") - " + tags.join(", ") + " " + people.join(", "));
	            }
	        }
	        else {
	...
	class EventItem extends React.Component {
	    render() {
	        return (React.createElement("tr", null, 
	            React.createElement("td", null, this.props.item.summary)
	        ));
	    }
	}
	const EventList = (props) => (props.events.map((ev) => (React.createElement(EventItem, {item: ev}))));
